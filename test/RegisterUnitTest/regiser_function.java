...
public class regiser_function {
    ...
    public String isPwd(String pwd1, String pwd2) {                     //判定密码输入规则
        int pwdflag1 = 0, pwdflag2 = 0, pwdflag3 = 0,pwdflag4 = 0;
        ...
        if (!pwd1.equals(pwd2)) {
            return "两次密码不一致";
        } else if (pwdflag1 == 1 && pwdflag2 == 1 && pwdflag3 == 1 && pwdflag4 == 1 && pwd1.length() > 6 && pwd1.length() < 12) {
            return "输入合法";
